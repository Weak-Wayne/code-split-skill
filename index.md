...
![code-split-skill Preview](https://github.com/KAOPU-XiaoPu/web-design/raw/main/docs/images/preview/hero.webp)
...
Clone into your IDE skills directory:

```bash
git clone https://github.com/your-username/code-split-skill ~/.trae/skills/code-split-skill
```

Your IDE will auto-discover the SKILL on next session start.
...
For detailed usage instructions, configuration options, and API reference, please see the [full documentation](./README.md).
...
[Documentation](./README.md) · [Report Issues](https://github.com/your-username/code-split-skill/issues) · [Install](#-install)
